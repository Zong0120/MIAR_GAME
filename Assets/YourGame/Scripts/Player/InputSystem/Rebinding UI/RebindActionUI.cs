    ...
    public class RebindActionUI : MonoBehaviour
    {
        ...
        private bool CheckDuplicateBindings(InputAction action, int bindingIndex,bool allCompositeParts = false)
        {
            ...
            foreach(InputBinding b in action.actionMap.bindings)
            {
                ...
                {
                    Debug.Log("Duplicate Binding Find:"+b.effectivePath);
                    return true;
                }
            } 
            if(allCompositeParts)
            {
                ...
                {
                    if(action.bindings[i].effectivePath == binding.overridePath)
                    {
                        Debug.Log("Duplicate Binding Find:"+binding.effectivePath);
                        return true;
                    }
                }
            } 
        ...
        [Tooltip("What text should be displayed on the action label")]
        [SerializeField]
